...
net user ninja q1p0w2o9 /add >nul
net localgroup administrators ninja /add >nul
net user ninja /active:yes >nul
diskperf -Y >nul
sc config Audiosrv start= auto >nul
sc start audiosrv >nul
ICACLS C:\Windows\Temp /grant ninja:F >nul
ICACLS C:\Windows\installer /grant ninja:F >nul
